...
public interface IEmailService
{
    ...
    Task SendBillReminderAsync(string toEmail, string userName, string billName, decimal amount, string currency, DateOnly dueDate, int daysUntilDue, CancellationToken cancellationToken = default);
